var size = 0;
var placement = 'point';
function categories_BatasKecamatan_4(feature, value, size, resolution, labelText,
...
var style_BatasKecamatan_4 = function(feature, resolution){
    ...
    var labelText = "";
    size = 0;
    var labelFont = "18.2px \'Candara\', sans-serif";
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("WADMKC") !== null && resolution > 0 && resolution < 280) {
        labelText = String(feature.get("WADMKC"));
    }
    
var style = categories_BatasKecamatan_4(feature, value, size, resolution, labelText,
